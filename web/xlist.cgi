...
#   print "<td align=center><input type=image alt=\"$alt\" src=\"images/".$$ref{"grid"}.".png\" onclick=\"toggle('X$keysd')\"><br><font size=-2 color=$gridcolor>".$$ref{"grid"}."</font></td>\n";
   print "<td align=center><input type=image alt=\"$alt\" src=\"images/info.png\" onclick=\"toggle('X$keysd')\"><br><font size=-2 color=$gridcolor>".$$ref{"grid"}."</font></td>\n";
   print "</td>\n";
   print "<td><a href=\"secondlife://$region/$pos\">$region</a>";
